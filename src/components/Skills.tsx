...
import { Code, PenTool, Database, Globe, Settings, Users } from 'lucide-react';
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {category.skills.map((skill) => (
                  <span
                    key={skill}
                    className="bg-white text-gray-700 px-3 py-1 rounded-full text-sm border border-gray-200 skill-item"
                  >
                    {skill}
                  </span>
                ))}
